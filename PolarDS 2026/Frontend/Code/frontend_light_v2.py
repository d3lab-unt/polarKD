...
# This app lives in Frontend/Code/, but its Knowledge-Graph modules live in
# the sibling top-level folder Knowledge_graph/Code/, so it must be added to
# sys.path before the project-internal imports below can resolve.
